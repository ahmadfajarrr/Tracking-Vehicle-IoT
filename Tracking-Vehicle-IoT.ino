...
// Konfigurasi SoftwareSerial untuk modul GPS
SoftwareSerial SerialGPS(12, 13); // RX, TX (Contoh pin 12 dan 13, sesuaikan dengan yang tersedia)
TinyGPSPlus gps;

// Pin kontrol relay
const int relayPin = 2; // Contoh pin GPIO14 untuk mengontrol relay
...
void setup() {
  ...
  digitalWrite(relayPin, LOW); // Matikan relay saat awalnya
  ...
  // Konfigurasi dan inisialisasi komunikasi dengan modul GPS
...
//        Serial.println(longitude, 6);
        ...
        // Kirim data GPS ke broker MQTT
        char gpsDataChar[100]; // Buffer untuk data GPS
